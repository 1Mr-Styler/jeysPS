...
class Inactive: NSObject {
    ...
    @IBAction func toggleInactivity(sender: AnyObject) {
    ...
    func updateData() {
        if let url = NSURL(string: "http://localhost/jenny/apr.php?cdc=\(userHandler.cdc)&sh=0&ih=\(Ran)&ph=0&wh=0&ach=0") {
            do {
